...
from utils.mpi import average_gradients, broadcast_model
...
parser.add_argument("--task", type=str, default="cartpole", choices=envs)
parser.add_argument(
    "--action",
    type=str,
    default="train",
...
parser.add_argument("--algo", type=str, default="PPO", choices=["VPG", "PPO", "DQN"])
